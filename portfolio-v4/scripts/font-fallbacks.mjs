...
const serif = open(`${FS}/instrument-serif/files/instrument-serif-latin-400-normal.woff`);
const serifItalic = open(`${FS}/instrument-serif/files/instrument-serif-latin-400-italic.woff`);
const sans = open(`${FS}/ibm-plex-sans/files/ibm-plex-sans-latin-400-normal.woff`);

const georgia = open(`${SYS}/Supplemental/Georgia.ttf`);
const georgiaItalic = open(`${SYS}/Supplemental/Georgia Italic.ttf`);
...
${face('Instrument Serif Fallback', 'Georgia', 'normal', serif, georgia)}
${face('Instrument Serif Fallback', 'Georgia Italic', 'italic', serifItalic, georgiaItalic)}
${face('IBM Plex Sans Fallback Arial', 'Arial', 'normal', sans, arial)}
${face('IBM Plex Sans Fallback Helvetica', 'Helvetica Neue', 'normal', sans, helvetica)}
`;
