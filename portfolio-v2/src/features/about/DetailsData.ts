// DetailsData.ts - Data for the Details component
...
export const databasesAndCloudSkills: SkillItem[] = [
  {
    name: "PostgreSQL",
    percent: 85,
    color:
...
export const languages: string[] = ["Fluent: English, Spanish", "Intermediate: French"];

export const busyWith: string[] = [
  "Coding new projects",
  "Playing video games",
  "Going to the Gym",
];
